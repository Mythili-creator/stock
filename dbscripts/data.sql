...
CREATE TABLE IF NOT EXISTS `stock-market-charting`.`stock_exchange` (
  `se_id` BIGINT(10) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `stock-market-charting`.`role` (`ro_id`, `ro_name`) VALUES ('1', 'ADMIN');
INSERT INTO `stock-market-charting`.`role` (`ro_id`, `ro_name`) VALUES ('2', 'USER');

INSERT INTO `stock-market-charting`.`user` (`us_id`, `us_name`, `us_password`, `us_email`, `us_mobile_number`, `us_confirmed`, `us_ro_id` ) VALUES
('1', 'admin', '$2a$10$R/lZJuT9skteNmAku9Y7aeutxbOKstD5xE5bHOf74M2PHZipyt3yK', 'admin@gmail.com', '9876543210', '1', '1');

INSERT INTO `stock-market-charting`.`user_role` (`ur_id`,`ur_us_id`,`ur_ro_id`) VALUES (1,1,1);
INSERT INTO `stock-market-charting`.`user_role` (`ur_id`,`ur_us_id`,`ur_ro_id`) VALUES (2,2,1);


INSERT INTO `stock-market-charting`.`company` (`co_id`, `co_name`, `co_turnover`, `co_sector`, `co_ceo`, `co_board_of_directors`, `co_brief_writeup`,
 `co_stock_code`) VALUES ('1', 'ITC', '100000', 'public', 'Sanjiv Puri', 'Sanjiv Puri', 'Produces Biscuits,Chips', '1');
 
 

INSERT INTO `stock-market-charting`.`stock_exchange` (`se_id`, `se_stock_exchange`, `se_brief`, `se_contact_address`, `se_remark`)
VALUES ('1', 'BSE', 'BOMBAY STOCK EXCHANGE', 'BSE,Mumbai,India', 'Best in India');
INSERT INTO `stock-market-charting`.`stock_exchange` (`se_id`, `se_stock_exchange`, `se_brief`, `se_contact_address`, `se_remark`)
VALUES ('2', 'NSE', 'NATIONAL STOCK EXCHANGE', 'NSE,Delhi,India', 'NIFTY');
